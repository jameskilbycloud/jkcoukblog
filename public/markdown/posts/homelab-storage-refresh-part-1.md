...
By[James](https://jameskilby.co.uk) May 23, 2023 · Updated July 11, 2026 • 📖9 min read(1,858 words)
...
Related: [TrueNAS Scale CLI Reference: Storage &#038; Kubernetes Commands](https://jameskilby.co.uk/2023/11/truenas-scale-useful-commands/)
...
ZFS, like a lot of modern storage technologies (VSAN etc.), wants exclusive access to the underlying disks. This means using an HBA-based device rather than a RAID card. ZFS then groups these drives into a “Pool” 
...
ARC, or Adaptive Read Cache, is a high-speed in-memory cache that stores recently accessed data. L2ARC stands for Level 2 ARC. It is a secondary cache that can be used to store data that is not currently in ARC. L2ARC can be implemented using storage devices, such as SSDs or NVMe drives. 
...
![Synology](https://jameskilby.co.uk/wp-content/uploads/2022/01/Synology-1024x725.png)Synology Performance
