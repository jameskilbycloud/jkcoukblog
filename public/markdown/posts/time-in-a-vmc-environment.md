...
modified: 2026-07-11T07:33:15+00:00
author: James Kilby
categories:
  - VMware Cloud on AWS
  - VMware
...
By[James](https://jameskilby.co.uk)December 8, 2025 · Updated July 11, 2026 • 📖3 min read(614 words)

📅**Published:** December 08, 2025•**Updated:** July 11, 2026

This post covers how Time Sync works in VMware Cloud on AWS (VMC), using the [Amazon Time Sync Service](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/set-time.html) to keep accurate NTP across your SDDC. One of the nice things about the VMC Service is that you don’t have to worry about a number of the traditional infrastructure services that you typically obsess over when you’re running your own infrastructure. One of those is Time — a key requirement for any enterprise platform.
