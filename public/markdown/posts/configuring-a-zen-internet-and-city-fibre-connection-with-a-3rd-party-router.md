...
modified: 2026-06-01T19:02:54+00:00
author: James Kilby
categories:
  - Networking
  - Homelab
...
By[James](https://jameskilby.co.uk) November 15, 2023June 1, 2026 • 📖2 min read(316 words)
...
To utilise the other addresses allocated by Zen these are added to the secondary tab as /32s
...
And that’s all there is to it. With the above config, I have my 6 usable IPs up and running.

One of the nice capabilities that the WatchGuard Firewall has is that it can monitor your interfaces (and make routing decisions if multiple connections are available)
